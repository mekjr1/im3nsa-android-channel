...
import io.im3nsa.canalandroid.data.DBCommandHelper;
import io.im3nsa.canalandroid.payload.MTTextMessage;
import io.im3nsa.canalandroid.payload.ResetCommand;
import io.im3nsa.canalandroid.R;
...
public class RapidPro extends Application {
    ...
    public void refreshInstalledPacks() {
        ...
        for (ApplicationInfo packageInfo : packages) {
            if (packageInfo.packageName.startsWith("io.im3nsa.canalandroid") &&
    ...
    public void showNotification() {
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                        ...
                        .setContentTitle("Mensageiro")
                        .setContentText("Mensageiro is active and relaying messages.")
                        .setOngoing(true);
    ...
    public void installPack(Context context){
        ...
        int packToInstall = 0;
        for (int i=1; i<=10; i++) {
            if (!packs.contains("io.im3nsa.canalandroid.pack" + i)) {
                packToInstall = i;
                break;
            }
        }
        ...
        if (packToInstall > 0) {
            ...
            intent.setData(Uri.parse("market://details?id=io.im3nsa.canalandroid.pack" + packToInstall));
